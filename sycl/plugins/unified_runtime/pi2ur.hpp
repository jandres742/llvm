...
inline pi_result piDevicesGet(pi_platform Platform, pi_device_type DeviceType,
  ...
  HANDLE_ERRORS(
      urDeviceGet(UrPlatform, Type->second, NumEntries, UrDevices, NumDevices));
...
inline pi_result piDeviceGetInfo(pi_device Device, pi_device_info ParamName,
  ...
  HANDLE_ERRORS(urDeviceGetInfo(UrDevice, InfoType->second, SizeInOut,
                                ParamValue, ParamValueSizeRet));
...
inline pi_result piEnqueueMemBufferMap(
  ...
  urEnqueueMemBufferMap(UrQueue, UrMem, BlockingMap, UrMapFlags, Offset, Size,
                        NumEventsInWaitList, UrEventsWaitList, UrEvent, RetMap);
