...
struct _ur_mem_handle_t : _pi_object {
  ...
  virtual ~_ur_mem_handle_t() = default;

protected:
  _ur_mem_handle_t(ur_context_handle_t Context) : UrContext{Context} {}

  _ur_mem_handle_t(ur_context_handle_t Context, ur_device_handle_t Device) :
    UrContext{Context}, UrDevice(Device) {}
};

struct _pi_buffer final : _ur_mem_handle_t {
  // Buffer constructor
  _pi_buffer(ur_context_handle_t Context, ur_device_handle_t UrDevice, size_t Size);

  _pi_buffer(ur_context_handle_t Context, size_t Size, char *HostPtr,
             bool ImportedHostPtr);

  // Sub-buffer constructor
  _pi_buffer(_pi_buffer *Parent, size_t Origin, size_t Size)
      : _ur_mem_handle_t(Parent->UrContext), Size(Size),
        SubBuffer{Parent, Origin} {}

  // Interop-buffer constructor
  _pi_buffer(ur_context_handle_t Context, size_t Size, ur_device_handle_t Device,
...
struct _ur_image final : _ur_mem_handle_t {
  // Image constructor
  _ur_image(ur_context_handle_t UrContext, ze_image_handle_t ZeImage)
      : _ur_mem_handle_t(UrContext), ZeImage{ZeImage} {}
